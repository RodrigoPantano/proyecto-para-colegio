    ...
    const cajas = [
        {
            id: 1, title: '1er misterio', content: `<p>
                    U: Contemplamos los misterios luminosos. En el primer misterio luminoso contemplamos El Bautismo del Señor. <br /> <br />
                ...
                </p>` },
        {
            id: 2, title: '2do misterio', content: ` <p>
                    U: En el segundo misterio luminoso contemplamos Las Bodas de Caná. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
                ...
                </p>` },
        {
            id: 3, title: '3er misterio', content: `<p>
                    U: En el tercer misterio luminoso contemplamos El anuncio del Reino de Dios y el llamado a la conversión. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
                ...
                </p>` },
        {
            id: 4, title: '4to misterio', content: `<p>
                    U: En el cuarto misterio luminoso contemplamos La transfiguración del Señor. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
                ...
                </p>` },
        {
            id: 5, title: '5to misterio', content: `<p>
                    U: En el quinto misterio luminoso contemplamos La Institución de la Eucaristía. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
