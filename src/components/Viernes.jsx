    ...
    const cajas = [
        {
            id: 1, title: '1er misterio', content: `<p>
                    U: Contemplamos los misterios dolorosos. En el primer misterio doloroso contemplamos La Oración y Agonía de Jesús en el Huerto. <br /> <br />
                ...
                </p>` },
        {
            id: 2, title: '2do misterio', content: `<p>
                    U: En el segundo misterio doloroso contemplamos La Flagelación de Nuestro Señor.<br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br /> 
                ...
                </p>` },
        {
            id: 3, title: '3er misterio', content: `<p>
                    U: En el tercer misterio doloroso contemplamos La Coronación de espinas. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
                ...
                </p>` },
        {
            id: 4, title: '4to misterio', content: `<p>
                    U: En el cuarto misterio doloroso contemplamos Jesús con la Cruz a cuestas camino al Calvario. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
                ...
                </p>` },
        {
            id: 5, title: '5to misterio', content: `<p>
                    U: En el quinto misterio doloroso contemplamos La Crucifixión y Muerte de Nuestro Señor. <br /> <br />
                    U: Padre nuestro que estás en el cielo, santificado sea tu Nombre; venga a nosotros tu reino; hagase tu voluntad en la tierra como en
                    el cielo. <br />
                    T: Danos hoy el pan de cada día; perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden; no nos dejes caer
                    en la tentación, y libranos del mal. Amén. <br />
